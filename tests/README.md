...
| **Gantt Page**            | `GanttPage`, `CurriculumFab`, `CurriculumView`, `CurriculumViewTabs`                             | `gantt.spec.ts`    | Page load with placeholder, curriculum drawer open, curriculum selection, loading screen, tab navigation (syllabuses/builder/gantt-view/weeks), URL param sync (`?gc=`, `?v=`)                   |
