...
const RAW_EVENTS: IRawEvent[] = [
    ...
    },
    {
        ...
        durationHours: 2,
        dateStr: "2026-02-02",
        notes: "להכין מצגצ תדרוך, יחד עם הצגת סביבת עבודה ותיקיות. כדאי לאפשר לחלק מהאנשים להתחבר בבוקר",
        inCharge: "אופק",
        lecturer: "אופק",
    },
    {
...
class DatabaseSeeder {
    ...
    public async seed(events: DbEventDocument[]): Promise<void> {
        try {
            ...
            const collection = db.collection<DbEventDocument>(
                this.collectionName,
            );
            ...
            console.log(
                `[INFO] Cleared existing collection: ${this.collectionName}`,
            );
