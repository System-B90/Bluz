...
const FAKE_EVENTS = [
    ...
    '"לכסות מוסתרים": list_events עם hidden=true ו-fields=["courses"] לאותו יום. כסה כל רצף מוסתרים באירועים פיקטיביים שמתחילים בתחילת המוסתר הראשון ונגמרים בסוף האחרון, בלי חפיפה ביניהם. החלוקה הפנימית חופשית — עדיף לערבב סוגים ושעות ולא להעתיק את המוסתרים אחד לאחד. אותם קורסים. טווח שכבר יש בו אירוע גלוי — דלג ודווח.',
