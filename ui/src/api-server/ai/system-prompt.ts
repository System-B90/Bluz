...
const FAKE_EVENTS = [
    ...
    '"לכסות מוסתרים": list_events עם hidden=true ו-fields=["courses"] לאותו יום, ואירוע פיקטיבי אחד לכל מוסתר — אותן שעות ואותם קורסים. טווח שכבר יש בו אירוע גלוי — דלג ודווח.',
