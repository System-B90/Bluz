...
export {
  ...
  ganttCurriculumModuleDayMappingsRelationsSchema as ganttModuleDayAssignmentsRelationsSchema,
  ganttCurriculumModuleDayMappingsSchema as ganttModuleDayAssignmentsSchema,
} from "./mappings";
