import { Curriculum, CurriculumDay, CurriculumId, CurriculumWeek, CurriculumWeekId, Module, ModuleEvent, ModuleId, Syllabus, SyllabusId } from "@/api-shared/types/gantt/curriculum";
 ...
 */
export interface CreateCurriculumWeekPayload extends Omit<CurriculumWeek, 'days' | 'id' | 'title'>
{
