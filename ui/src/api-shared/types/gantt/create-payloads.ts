 ...
 */
export interface CreateGanttCurriculumPayload extends Omit<GanttCurriculum, 'id' | 'syllabuses' | 'weeks'>
{
 ...
 */
export interface CreateGanttWeekPayload extends Omit<GanttWeek, 'days' | 'id' | 'title'>
{
 ...
 */
export interface CreateGanttSyllabusPayload extends Omit<GanttSyllabus, 'id' | 'modules'>
{
    curriculumId: GanttCurriculumId;
}
 ...
 */
export interface CreateGanttModulePayload extends Omit<GanttModule, 'events' | 'id'>
{
