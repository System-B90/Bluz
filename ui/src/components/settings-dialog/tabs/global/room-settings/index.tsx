...
export function RoomSettings()
{
    ...
    const populateFormFromRoom = useCallback((room: Room) =>
    {
        ...
        setWorkstationCount(ext.workstationCount !== null ? String(ext.workstationCount) : "");
        setLectureSeatCount(ext.lectureSeatCount !== null ? String(ext.lectureSeatCount) : "");
    ...
    const buildExtendedInfo = useCallback(
        (): RoomExtendedInfo => ({
            workstationCount: workstationCount.trim() ? parseInt(workstationCount, 10) : null,
