...
import GanttEngine from '@/components/gant/curriculum-view/tabs/gantt-view-tab/GanttEngine';
import { GanttDataResult, GanttDataSourceProps, SvarGanttDataUpdateEvent, SvarGanttScale } from '@/components/gant/curriculum-view/tabs/gantt-view-tab/types';
import { useGanttData } from '@/components/gant/curriculum-view/tabs/gantt-view-tab/useGanttData';
