 ...
 * loaded curriculum's search items, opens its module dialog with the event
 * itself open — the same navigation the search field's event results use.
 * Renders nothing; mount inside `CurriculumProvider`.
 */
export function GanttEventDeepLink() {
    ...
    }, [targetEventId, items, openEventDialog, router, pathname, searchParams]);
