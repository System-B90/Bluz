...
export type Action =
    ...
    | { type: "ADD_WEEK"; payload: { week: GanttWeek & { id: GanttWeekId; }; curriculumId: GanttCurriculumId; }; }
    ...
    | { type: "REMOVE_WEEK"; payload: { weekId: GanttWeekId; curriculumId: GanttCurriculumId; }; }
            ...
            return {
                ...
                curriculums: {
                    ...
                    [ action.payload.curriculumId ]: {
                        ...
                        weeks: [ ...state.curriculums[ action.payload.curriculumId ].weeks, action.payload.week.id ],
                    },
                },
            };
        }
