...
function calculateSumValueForModuleByField(module: GanttModule, fieldName: NumberFieldKeys<GanttEvent>, state: NormalizedStore): number
{
...
export function calculateMinimumRequiredTimeForModule(module: GanttModule, state: NormalizedStore): number
{
    return calculateSumValueForModuleByField(module, 'minimumDuration', state);
}

export function calculateAllocatedTimeForModule(module: GanttModule, state: NormalizedStore): number
{
...
function calculateSumForSyllabus(syllabus: GanttSyllabus, state: NormalizedStore, moduleCallbackFunc: CallbackFunc<GanttModule>): number
{
...
export function calculateMinimumRequiredTimeForSyllabus(syllabus: GanttSyllabus, state: NormalizedStore): number
{
    return calculateSumForSyllabus(syllabus, state, calculateMinimumRequiredTimeForModule);
}

export function calculateAllocatedTimeForSyllabus(syllabus: GanttSyllabus, state: NormalizedStore): number
{
    return calculateSumForSyllabus(syllabus, state, calculateAllocatedTimeForModule);
}

function calculateSumForCurriculum(curriculum: GanttCurriculum, state: NormalizedStore, syllabusCallbackFunc: CallbackFunc<GanttSyllabus>): number
{
...
export function calculateMinimumRequiredTimeForCurriculum(curriculum: GanttCurriculum, state: NormalizedStore): number
{
    return calculateSumForCurriculum(curriculum, state, calculateMinimumRequiredTimeForSyllabus);
}

export function calculateAllocatedTimeForCurriculum(curriculum: GanttCurriculum, state: NormalizedStore): number
{
