...
import { GanttCurriculumId, GanttModuleId, GanttSyllabusId } from "@/api-shared/types/gantt/models/curriculum";
...
import { calculateAllocatedTimeForModule, calculateMinimumRequiredTimeForModule } from '@/components/gantt/utils';
