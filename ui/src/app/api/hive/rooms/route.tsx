...
import { ApiHiveRoomsGetPayload, ApiHiveRoomsGetResponse } from "@/api-shared/types/hive";

type ServerApiHiveRoomsGet = ServerApi<ApiHiveRoomsGetPayload, ApiHiveRoomsGetResponse>;
