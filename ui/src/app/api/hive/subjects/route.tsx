...
import { ApiHiveSubjectsGetPayload, ApiHiveSubjectsGetResponse } from "@/api-shared/types/subject";

type ServerApiHiveSubjectsGet = ServerApi<ApiHiveSubjectsGetPayload, ApiHiveSubjectsGetResponse>;
