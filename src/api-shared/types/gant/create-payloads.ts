import { Curriculum, Syllabus, CurriculumId, SyllabusId, ModuleEvent, ModuleId, Module } from "@/api-shared/types/gant/curriculum";
 ...
 */
export interface CreateCurriculumPayload extends Omit<Curriculum, 'id' | 'syllabuses'>
{
    // Weeks and Days are embedded arrays, so they are passed during creation
}
